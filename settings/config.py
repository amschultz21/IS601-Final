...
class Settings(BaseSettings):
    ...
    mail_server: str = Field(default='smtp.mailtrap.io', description="SMTP server for sending emails")
    mail_port: int = Field(default=2525, description="SMTP port for sending emails")
    mail_username: str = Field(default='your-mailtrap-username', description="Username for SMTP server")
    mail_password: str = Field(default='your-mailtrap-password', description="Password for SMTP server")

# Toggle email sending
    email_enabled: bool = Field(default=True, description="Toggle email sending on/off")
